...
type as923IndonesiaBand struct {
	band
	dwellTime lorawan.DwellTime
}

func (b *as923IndonesiaBand) Name() string {
	return "AS923_INDONESIA"
}

func (b *as923IndonesiaBand) GetDefaults() Defaults {
	return Defaults{
...
func (b *as923IndonesiaBand) GetDownlinkTXPower(freq uint32) int {
	return 27
}

func (b *as923IndonesiaBand) GetDefaultMaxUplinkEIRP() float32 {
	return 20
}

func (b *as923IndonesiaBand) GetPingSlotFrequency(lorawan.DevAddr, time.Duration) (uint32, error) {
	return 923400000, nil
}

func (b *as923IndonesiaBand) GetRX1ChannelIndexForUplinkChannelIndex(uplinkChannel int) (int, error) {
	return uplinkChannel, nil
}

func (b *as923IndonesiaBand) GetRX1FrequencyForUplinkFrequency(uplinkFrequency uint32) (uint32, error) {
	return uplinkFrequency, nil
}

func (b *as923IndonesiaBand) GetRX1DataRateIndex(uplinkDR, rx1DROffset int) (int, error) {
...
func (b *as923IndonesiaBand) ImplementsTXParamSetup(protocolVersion string) bool {
	return true
}

func newAS923IndonesiaBand(repeaterCompatible bool, dt lorawan.DwellTime) (Band, error) {
	b := as923IndonesiaBand{
		dwellTime: dt,
		band: band{
