...
func (b *as923IndonesiaBand) GetDownlinkTXPower(freq int) int {
	return 27
}
...
func (b *as923IndonesiaBand) GetPingSlotFrequency(lorawan.DevAddr, time.Duration) (int, error) {
...
func (b *as923IndonesiaBand) GetRX1FrequencyForUplinkFrequency(uplinkFrequency int) (int, error) {
