...
func (b *as923JapanBand) GetRX1ChannelIndexForUplinkChannelIndex(uplinkChannel int) (int, error) {
...
func (b *as923JapanBand) GetRX1DataRateIndex(uplinkDR, rx1DROffset int) (int, error) {
